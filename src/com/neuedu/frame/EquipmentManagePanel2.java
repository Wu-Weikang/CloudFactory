...
public class EquipmentManagePanel2 extends JPanel {

	private static final long serialVersionUID = 1L;
	
	private static EquipmentManagePanel2 instance = null;
	...
	private EquipmentManagePanel2() {
			...
			public void actionPerformed(ActionEvent arg0) {
				...
				if (selectRowIndex != -1) {
					if(model.getValueAt(selectRowIndex, 7).equals("出租设备")) {
						...
						JOptionPane.showMessageDialog(null, "工厂自己的设备不能修改", "提示", JOptionPane.PLAIN_MESSAGE);
						return;
					}
				} else {
		...
		btnNewButton_1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				if(n == JOptionPane.OK_OPTION) {
					...
					if(model.getValueAt(selectRowIndex, 7).equals("出租设备")) {
						if (selectRowIndex != -1) {
							if(model.getValueAt(selectRowIndex, 7).equals("自有设备")) {
								EquipmentController pc = new EquipmentController("Equipment");
								...
								JOptionPane.showMessageDialog(null, "租用设备不允许删除", "提示", JOptionPane.PLAIN_MESSAGE);
								return;
							}
						} else {
						...
						JOptionPane.showMessageDialog(null, "工厂自己的设备不能删除", "提示", JOptionPane.PLAIN_MESSAGE);
						return;
					}
				}
			}
		...
		btnNewButton_2.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				cloudFactoryManagerFrame.setContentPane(AddEquipmentPanel2.getInstance());
			}
		});
		...
		btnNewButton_3.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				if (p != null && p.getBelong().equals(LoginFrame.loginAccount+"用户的云工厂")) {
		...
		JButton btnNewButton_7 = new JButton("租用设备");
		btnNewButton_7.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				JFrame cloudFactoryManagerFrame = CloudFactoryManagerFrame.getInstance();
				cloudFactoryManagerFrame.setVisible(true);
				cloudFactoryManagerFrame.setContentPane(RentEquipmentPanel.getInstance());
			}
		});
		btnNewButton_7.setBounds(155, 97, 93, 23);
		add(btnNewButton_7);
	}
	...
	public void initTable() {
		...
		if(olist != null) {
			for (int i = 0; i < olist.size(); i++) {
				...
				if(p.getBelong().equals(LoginFrame.loginAccount+"用户的云工厂")) {
					vRow = new Vector<Object>();
	...
	public static EquipmentManagePanel2 getInstance() {
		if(instance == null) {
			instance = new EquipmentManagePanel2();
		}
		return instance;
	}
}